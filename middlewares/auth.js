...
const isAuth=async(req,res,next)=>{
    try{
        ...
        console.log(decoded);
        req.user=await UserModel.findById(decoded._id); // we are setting the finding the details of the user by the decoded id so that we use the user details for pushing the likes comment and other details
